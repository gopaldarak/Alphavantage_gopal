...
public class MACDData {
	...
	public MACDData(LocalDateTime datetime, double signal, double hist,
			double macd) {
	...
	public String toString() {
		return "MACD(m;s;h)=,".concat((String.format("%.2f", macd)))
				.concat(",")
				.concat(String.format("%.2f", signal))
				.concat(",")
				.concat(String.format("%.2f", hist));
	}
}
